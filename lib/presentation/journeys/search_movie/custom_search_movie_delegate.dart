...
class CustomSearchDelegate extends SearchDelegate {
  ...
  @override
  List<Widget> buildActions(BuildContext context) { //right icon
    return [
      IconButton(
        icon: Icon(
          Icons.clear,
  ...
  @override
  Widget buildLeading(BuildContext context) { //left icon
  ...
  @override
  Widget buildResults(BuildContext context) { //result of search
    searchMovieBloc.add(
  ...
  @override
  Widget buildSuggestions(BuildContext context) { //suggestion
